...
package at.matthew.httpstreaming {
	...
	public class M3U8IndexInfo extends HTTPStreamingIndexInfoBase {
		
		private var _baseUrl:String;
		private var _streamInfos:Vector.<M3U8StreamInfo>;
		
		public function M3U8IndexInfo(baseUrl:String, streamInfos:Vector.<M3U8StreamInfo>=null) {
			_baseUrl = baseUrl;
			_streamInfos = streamInfos;
		}
		
		public function get baseUrl():String { return _baseUrl }
		public function get streamInfos():Vector.<M3U8StreamInfo> { return _streamInfos }
